          ...
          <Row>
            ...
            <FormGroup className='col-md-6'>
              ...
              <Errors
                ...
                messages={{
                  phoneValidator:
                    "The phone number should be a proper phone number ",
                  minLengthValidator:
                    "The phone field should have at least 10 chars",
                  maxLengthValidator:
                    "The phone field should have max 15 chars",
                }}
              />
            </FormGroup>
          </Row>
